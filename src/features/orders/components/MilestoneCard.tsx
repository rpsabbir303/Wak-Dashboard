...
import type { Milestone, MilestoneStatus } from '@/shared/types/api'
import { useDeleteMilestoneMutation, useUpdateMilestoneMutation, useUpdateMilestoneStatusMutation } from '@/features/orders'
